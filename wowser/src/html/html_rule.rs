...
impl Rule for HtmlRule {
    fn children(&self) -> Vec<RuleType<HtmlRule>> {
        match self {
            ...
            HtmlRule::DoctypeStart => vec![
                RuleType::Token(HtmlToken::DoctypeOpen.b())
            ],
            HtmlRule::DoctypeContents => vec![
                RuleType::RepeatableRule(HtmlRule::DoctypeContentsString.b())
            ],
            ...
            HtmlRule::TagEnd => vec![
                RuleType::Token(HtmlToken::TagEnd.b()),
            ],
            HtmlRule::Tag => vec![
                RuleType::Rule(HtmlRule::SelfClosingTag.b()),
                RuleType::Rule(HtmlRule::NonSelfClosingTag.b()),
            ],
            HtmlRule::SelfClosingTag => vec![
                RuleType::Sequence(vec![
                    HtmlRule::OpeningTagPrelude.b(),
                    HtmlRule::SelfClosingTagEnding.b(),
                ]),
            ],
            HtmlRule::SelfClosingTagEnding => vec![
                RuleType::Token(HtmlToken::TagSelfClosingEnd.b()),
            ],
            HtmlRule::NonSelfClosingTag => vec![
                RuleType::Sequence(vec![
            ...
            HtmlRule::OpeningTag => vec![
                RuleType::Sequence(vec![
                    HtmlRule::OpeningTagPrelude.b(),
                    HtmlRule::TagEnd.b(),
                ]),
            ],
            HtmlRule::OpeningTagPrelude => vec![
                RuleType::Sequence(vec![
                    HtmlRule::OpeningTagName.b(),
                    HtmlRule::OpeningTagAttributes.b(),
                ]),
            ],
            HtmlRule::OpeningTagName => vec![
                RuleType::Token(HtmlToken::TagStart.b()),
            ],
            HtmlRule::OpeningTagAttributes => vec![
                RuleType::RepeatableRule(HtmlRule::TagAttribute.b()),
            ],
            ...
            HtmlRule::AttributeName => vec![
                RuleType::Token(HtmlToken::AttributeName.b())
            ],
            HtmlRule::AttributeEquals => vec![
                RuleType::Token(HtmlToken::Equals.b()),
            ],
            ...
            HtmlRule::TagContents => vec![
                RuleType::Sequence(vec![
                    HtmlRule::Text.b(),
                    HtmlRule::TagsAndText.b(),
                ]),
                RuleType::Token(HtmlToken::Text.b()),
            ],
            HtmlRule::TagsAndText => vec![
                RuleType::RepeatableRule(HtmlRule::TagAndText.b()),
            ],
            ...
            HtmlRule::ClosingTag => vec![
                RuleType::Sequence(vec![
                    HtmlRule::ClosingTagStart.b(),
                    HtmlRule::TagEnd.b(),
                ]),
            ],
            HtmlRule::ClosingTagStart => vec![
                RuleType::Token(HtmlToken::ClosingTagStart.b()),
            ],
